...
Config.InterfaceColor = "#38a2e5" -- change interface color, color must be in hex
...
Config.ThemeParkPass = true --  -- enable this if you want use theme park pass item, you need create item with name "themeparkpass" in your inventory/framework, also for standalone you need create usable item, example is in server/other.lua

Config.ThemeParkPassTime = 20 -- time when normal theme park expire when player use it (in minutes)
...
Config.AttractionsSettings = {
	gforce = {
		...
		ticketprice = 0, -- price for ticket
...
Config.ThemeParkOwnedSettings = {
	...
	themeparkprice = 1000000, -- price of theme park
...
Config.ShootingRangePrizes = {
	{ -- score number
		...
		prizedata = 12, -- prize data example money amount
		prizelabel = "Money", -- prize label
	},
	{ -- score number
		minimumscore = 100, -- minimum score
		prizetype = "money",  -- prize type (you need add your types yourself in server/other.lua
		prizedata = 110, -- prize data example money amount
		prizelabel = "Money", -- prize label
	},	
}
...
function Notify(text)
	...
	TriggerEvent('QBCore:Notify', { text = "Тепето", caption = text }, "primary", 5000)
end
