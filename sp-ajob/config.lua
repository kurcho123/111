...
Config.DeathTime = 900                                       -- How long the timer is for players to bleed out completely and respawn at the hospital
...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ...
    ['beds'] = {
        { coords = vector4(364.13, -1385.04, 33.72, 137.19),    taken = false, model = -708683881 },
        { coords = vector4(361.04, -1382.47, 33.65, 140.14),  taken = false, model = -708683881 },
        { coords = vector4(358.00, -1379.78, 33.65, 136.53),   taken = false, model = -708683881 },
        { coords = vector4(355.00, -1377.51, 33.65, 142.53),    taken = false, model = -708683881 },
        { coords = vector4(351.94, -1374.90, 33.65, 140.71),   taken = false, model = -708683881 },
        --- paleto
    ...
    ['stations'] = {
        { label = Lang:t('info.pb_hospital'), coords = vector3(352.0, -1404.8, 32.65) }
    }
}
...
Config.AJobVehs = {
    SpawnPoints = {
        [1] = { x = 300.28, y = -1443.67, z = 29.79, w = 58.99 },
    },
    Vehicles = {
        -- Police Defaults
        ["ambulance"] = { -- Crown Victoria
...
Config.AJobHeli = {
    SpawnPointsHeli = {
        [1] = { x = 313.01, y = -1465.25, z = 46.90, w = 139.36 },
        [2] = { x = 300.23, y = -1452.58, z = 46.90, w = 149.09 },
    },
    Helicopter = {
        ["polmav"] = {
            DisplayName = "Медицински Хеликопетер",
            Job = "ambulance",
            RequiredRank = 2,
        },
    }
