...
function closeMenu() {
  ...
  $.post("https://sp-hud-encrypted/closeMenu");
}
function restartHud() {
  closeMenu();
  $.post("https://sp-hud-encrypted/restartHud");
}
function resetStorage() {
  closeMenu();
  $.post("https://sp-hud-encrypted/resetStorage");
}
function showOutMap() {
  $.post("https://sp-hud-encrypted/showOutMap");
}
function showOutCompass() {
  $.post("https://sp-hud-encrypted/showOutCompass");
}
function showFollowCompass() {
  $.post("https://sp-hud-encrypted/showFollowCompass");
}
function openMenuSounds() {
  $.post("https://sp-hud-encrypted/openMenuSounds");
}
function resetHudSounds() {
  $.post("https://sp-hud-encrypted/resetHudSounds");
}
function checklistSounds() {
  $.post("https://sp-hud-encrypted/checklistSounds");
}
function showMapNotif() {
  $.post("https://sp-hud-encrypted/showMapNotif");
}
function showFuelAlert() {
  $.post("https://sp-hud-encrypted/showFuelAlert");
}
function showCinematicNotif() {
  $.post("https://sp-hud-encrypted/showCinematicNotif");
}
function dynamicHealth() {
  $.post("https://sp-hud-encrypted/dynamicHealth");
}
function dynamicArmor() {
  $.post("https://sp-hud-encrypted/dynamicArmor");
}
function dynamicHunger() {
  $.post("https://sp-hud-encrypted/dynamicHunger");
}
function dynamicThirst() {
  $.post("https://sp-hud-encrypted/dynamicThirst");
}
function dynamicStress() {
  $.post("https://sp-hud-encrypted/dynamicStress");
}
function dynamicOxygen() {
  $.post("https://sp-hud-encrypted/dynamicOxygen");
}
function dynamicEngine() {
  $.post("https://sp-hud-encrypted/dynamicEngine");
}
function dynamicNitro() {
  $.post("https://sp-hud-encrypted/dynamicNitro");
}
function ToggleMapShape() {
  $.post("https://sp-hud-encrypted/ToggleMapShape");
}
function changeFPS() {
  $.post("https://sp-hud-encrypted/changeFPS");
}
function ToggleMapBorders() {
  $.post("https://sp-hud-encrypted/ToggleMapBorders");
}
function HideMap() {
  $.post("https://sp-hud-encrypted/HideMap");
}
function changeCompassFPS() {
  $.post("https://sp-hud-encrypted/changeCompassFPS");
}
function showCompassBase() {
  $.post("https://sp-hud-encrypted/showCompassBase");
}
function showStreetsNames() {
  $.post("https://sp-hud-encrypted/showStreetsNames");
}
function showPointerIndex() {
  $.post("https://sp-hud-encrypted/showPointerIndex");
}
function showDegreesNum() {
  $.post("https://sp-hud-encrypted/showDegreesNum");
}
function cinematicMode() {
  $.post("https://sp-hud-encrypted/cinematicMode");
}
