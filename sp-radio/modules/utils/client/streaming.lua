...
function utils.requestAnimSet(animSet, timeout)
...
function utils.requestStreamedTextureDict(textureDict, timeout)
...
function utils.requestNamedPtfxAsset(fxName, timeout)
