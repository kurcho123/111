local weapons = {
	...
	[GetHashKey("weapon_dp9")] = {recoil = 0.1, shake = 0.02},
	-- CUSTOM WEAPONS
	[GetHashKey("weapon_ak47")] = {recoil = 0.3, shake = 0.05},
	[GetHashKey("weapon_de")] = {recoil = 0.0, shake = 0.03},
	[GetHashKey("weapon_fnx45")] = {recoil = 0.1, shake = 0.03},
	[GetHashKey("weapon_glock17")] = {recoil = 0.1, shake = 0.03},
	[GetHashKey("weapon_m4")] = {recoil = 0.1, shake = 0.045},
	[GetHashKey("weapon_hk416")] = {recoil = 0.1, shake = 0.035},
	[GetHashKey("weapon_mk14")] = {recoil = 0.2, shake = 0.075}, -- Полицейски Снайпер
	[GetHashKey("weapon_m110")] = {recoil = 0.1, shake = 0.065}, -- Снайпер
	[GetHashKey("weapon_huntingrifle")] = {recoil = 0.1, shake = 0.065},
	[GetHashKey("weapon_ar15")] = {recoil = 0.1, shake = 0.035}, -- Полицейска мка
	[GetHashKey("weapon_m9")] = {recoil = 0.1, shake = 0.035}, -- Берета
	[GetHashKey("weapon_m70")] = {recoil = 0.2, shake = 0.055},
	[GetHashKey("weapon_m1911")] = {recoil = 0.1, shake = 0.065},
	[GetHashKey("weapon_mac10")] = {recoil = 0.2, shake = 0.055},
	[GetHashKey("weapon_uzi")] = {recoil = 0.2, shake = 0.065},
	[GetHashKey("weapon_mp9")] = {recoil = 0.2, shake = 0.045},
	[GetHashKey("weapon_mossberg")] = {recoil = 0.2, shake = 0.065},
	[GetHashKey("weapon_remington")] = {recoil = 0.2, shake = 0.065},
	[GetHashKey("weapon_scarh")] = {recoil = 0.2, shake = 0.035},
}
