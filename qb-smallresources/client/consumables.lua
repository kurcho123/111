...
RegisterNetEvent('consumables:client:UseJoint', function()
    QBCore.Functions.Progressbar("smoke_joint", Lang:t('consumables.joint_progress'), 1500, false, true, {
        ...
        TriggerServerEvent('hud:server:RelieveStress', math.random(80, 100))
...
RegisterNetEvent('consumables:client:UseArmor', function()
    ...
    QBCore.Functions.Progressbar("use_armor", Lang:t('consumables.armor_progress'), 20000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('consumables:client:UseHeavyArmor', function()
    ...
    QBCore.Functions.Progressbar("use_heavyarmor", Lang:t('consumables.heavy_armor_progress'), 20000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('consumables:client:UseArmorPolice', function()
    if GetPedArmour(PlayerPedId()) >= 50 then QBCore.Functions.Notify(Lang:t('consumables.armor_full'), 'error') return end
    local ped = PlayerPedId()
    local PlayerData = QBCore.Functions.GetPlayerData()
    if PlayerData.job.name ~= "police" then QBCore.Functions.Notify("Не си полицай.", 'error') return end
    QBCore.Functions.Progressbar("use_armor", Lang:t('consumables.armor_progress'), 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["armor"], "remove")
        TriggerServerEvent('hospital:server:SetArmor', 50)
        TriggerServerEvent("consumables:server:useArmorPolice")
        SetPedArmour(PlayerPedId(), 50)
    end)
end)

RegisterNetEvent('consumables:client:UseHeavyArmorPolice', function()
    if GetPedArmour(PlayerPedId()) == 100 then QBCore.Functions.Notify(Lang:t('consumables.armor_full'), 'error') return end
    local ped = PlayerPedId()
    local PlayerData = QBCore.Functions.GetPlayerData()
    if PlayerData.job.name ~= "police" then QBCore.Functions.Notify("Не си полицай.", 'error') return end
    QBCore.Functions.Progressbar("use_heavyarmor", Lang:t('consumables.heavy_armor_progress'), 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["heavyarmor"], "remove")
        TriggerServerEvent('hospital:server:SetArmor', 100)
        TriggerServerEvent("consumables:server:useHeavyArmorPolice")
        SetPedArmour(ped, 100)
    end)
end)
