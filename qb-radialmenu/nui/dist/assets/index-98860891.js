...
const nuiAction = async (action, body = {}) => {
  ...
  const fetchResult = await fetch(`https://qb-radialmenu/${action}`, {
    method: "POST",
    headers: {
...
const _tmpl$ = /*#__PURE__*/ template(
  ...
  _tmpl$6 = /*#__PURE__*/ template(
    `<svg width="255" height="150" viewBox="0 0 424 150" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="paint0_radial_357_379" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(53 61) rotate(90) scale(69.3593 39.0146)"><stop stop-color="#1A1D29" stop-opacity="0.92"></stop><stop offset="1" stop-color="#222530"></stop></radialGradient><radialGradient id="paint1_radial_357_379" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(48 61) rotate(55.8786) scale(110.527 1790.87)"><stop stop-color="white"></stop><stop offset="1" stop-color="white"></stop></radialGradient><radialGradient id="paint0_radial_87_2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(60.5 7.5) rotate(90) scale(58.5)"><stop stop-color="#38a2e5"></stop><stop offset="1" stop-color="#38a2e5" stop-opacity="0"></stop></radialGradient><linearGradient id="paint1inear_87_2" x1="60.5" y1="0" x2="60.5" y2="39" gradientUnits="userSpaceOnUse"><stop stop-color="#38a2e5"></stop><stop offset="1" stop-color="#38a2e5" stop-opacity="0"></stop></linearGradient><radialGradient id="paint2_radial_87_2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(60.5 142.5) rotate(-90) scale(58.5)"><stop stop-color="#38a2e5"></stop><stop offset="1" stop-color="#38a2e5" stop-opacity="0"></stop></radialGradient><linearGradient id="paint3inear_87_2" x1="60.5" y1="150" x2="60.5" y2="111" gradientUnits="userSpaceOnUse"><stop stop-color="#38a2e5"></stop><stop offset="1" stop-color="#38a2e5" stop-opacity="1"></stop></linearGradient><radialGradient id="paint4_radial_87_2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(61 75) rotate(45) scale(115.023)"><stop stop-color="#38a2e5"></stop><stop offset="1" stop-color="#38a2e5" stop-opacity="0">`
  ),
  _tmpl$7 = /*#__PURE__*/ template(
    `<svg><g class="icon-container"><path class="hover-child-t" d="M63.25 2.16506L91.458 18.451C93.1597 19.4334 94.208 21.2491 94.208 23.2141V55.7859C94.208 57.7509 93.1597 59.5666 91.458 60.549L63.25 76.8349C61.5483 77.8174 59.4517 77.8174 57.75 76.8349L29.542 60.549C27.8403 59.5666 26.792 57.7509 26.792 55.7859V23.2141C26.792 21.2491 27.8403 19.4334 29.542 18.451L57.75 2.16506C59.4517 1.18258 61.5483 1.18258 63.25 2.16506Z" fill="url(#paint0_radial_87_2)" fill-opacity="0.85" stroke="url(#paint1inear_87_2)"></path><path class="hover-child-b" d="M63.25 147.835L91.458 131.549C93.1597 130.567 94.208 128.751 94.208 126.786V94.2141C94.208 92.2491 93.1597 90.4334 91.458 89.451L63.25 73.1651C61.5483 72.1826 59.4517 72.1826 57.75 73.1651L29.542 89.451C27.8403 90.4334 26.792 92.2491 26.792 94.2141V126.786C26.792 128.751 27.8403 130.567 29.542 131.549L57.75 147.835C59.4517 148.817 61.5483 148.817 63.25 147.835Z" fill="url(#paint2_radial_87_2)" fill-opacity="0.85" stroke="url(#paint3inear_87_2)"></path><path class="hover-ef-bg" d="M63.75 16.1651L110.578 43.201C112.279 44.1834 113.328 45.9991 113.328 47.9641V102.036C113.328 104.001 112.279 105.817 110.578 106.799L63.75 133.835C62.0483 134.817 59.9517 134.817 58.25 133.835L11.4224 106.799C9.72074 105.817 8.67245 104.001 8.67245 102.036V47.9641C8.67245 45.9991 9.72075 44.1834 11.4225 43.201L58.25 16.1651C59.9517 15.1826 62.0483 15.1826 63.75 16.1651Z" fill="#1A1D29" fill-opacity="1" stroke=""></path><path class="hover-ef" d="M63.75 16.1651L110.578 43.201C112.279 44.1834 113.328 45.9991 113.328 47.9641V102.036C113.328 104.001 112.279 105.817 110.578 106.799L63.75 133.835C62.0483 134.817 59.9517 134.817 58.25 133.835L11.4224 106.799C9.72074 105.817 8.67245 104.001 8.67245 102.036V47.9641C8.67245 45.9991 9.72075 44.1834 11.4225 43.201L58.25 16.1651C59.9517 15.1826 62.0483 15.1826 63.75 16.1651Z" fill="url(#paint4_radial_87_2)" fill-opacity="0.85" stroke="#38a2e5"></path><text fill="#ffffff8c" font-family="gilroy400" font-size="14" x="60" y="84" text-anchor="middle"></svg>`,
    false,
    true
  ),
...
const interfaceView = (props) => {
  ...
  const InterfaceInteractionItems = () => {
    return (() => {
      ...
      insert(_el$12, () =>
        isTopLevel() && !activeSmall() ? "Изход" : "Назад"
      );
      createRenderEffect(() =>
