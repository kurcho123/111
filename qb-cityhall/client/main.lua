...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    ...
    lib.registerContext({
        ...
        options = {
          {
            title = 'Документи',
            description = 'Ще намерите всички документи, от които може да се нуждаете, в нашия град.',
            icon = 'fas fa-passport',
            onSelect = function()
                lib.registerContext({
                    id = 'cityhall_documents_menu',
                    title = 'Община - Документи',
                    menu = "cityhall_menu",
                    options = {
                        {
                            title = 'Лична Карта',
                            description = 'Този документ помага на властите да ви идентифицират.',
                            icon = 'fas fa-passport',
                            serverEvent = "qb-cityhall:server:requestId",
                            metadata = {
                                {label = 'Цена', value = '$150'}
                            },
                            args = {
                                item = "id_card",
                                hall = 1,
                        ...
                        },
                        {
                            ...
                            description = 'Този документ ви дава право да управлявате автомобил законно.',
                            icon = 'fas fa-passport',
                            serverEvent = "qb-cityhall:server:requestId",
                            metadata = {
                                {label = 'Цена', value = '$500'}
                            },
                            args = {
                                item = "driver_license",
                                hall = 1,
                        ...
                        {
                            title = 'Адвокатска Карта',
                            description = 'Този документ служи за идентифицирането ви като адвокат.',
                            icon = 'fas fa-passport',
                            serverEvent = "qb-cityhall:server:requestId",
                            metadata = {
                                {label = 'Цена', value = '$100'}
                            },
                            args = {
                                item = "lawyerpass",
                                hall = 1,
                ...
                lib.showContext("cityhall_documents_menu")
            end,
            arrow = true,
          },
          {
            title = 'Лицензи',
            description = 'Ще намерите всички лицензи, от които може да се нуждаете, в нашия град.',
            icon = 'fas fa-passport',
            onSelect = function()
                lib.registerContext({
                    id = 'cityhall_licenses_menu',
                    title = 'Община - Лицензи',
                    menu = "cityhall_menu",
                    options = {
                        {
                            title = 'Пилотски Лиценз',
                            description = 'Този лиценз ви дава правото да управлявате хеликоптер.',
                            icon = 'fas fa-passport',
                            serverEvent = "qb-cityhall:server:requestLicense",
                            disabled = PlayerData.metadata.pilotlicense,
                            metadata = {
                                {label = 'Цена', value = '$100000'}
                            },
                            args = {
                                item = "pilotlicense",
                                hall = 1,
