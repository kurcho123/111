...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(480.49, -1009.20, 30.69, 264.00),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "police",
        coords = vector4(475.37, -992.19, 30.69, 179.68),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
...
Config.Outfits = {
    ["police"] = {
        ["Male"] = {
            {
                name = "Препоръчителна Униформа",
                outfitData = {
                    ["pants"] = {item = 10, texture = 0}, -- Pants
                    ["arms"] = {item = 19, texture = 0}, -- Arms
                    ["t-shirt"] = {item = 58, texture = 0}, -- T Shirt
                    ["vest"] = {item = 65, texture = 0}, -- Body Vest
                    ["torso2"] = {item = 453, texture = 1}, -- Jacket
        ...
        ["Female"] = {
            {
                ...
                outfitData = {
                    ...
                    ["t-shirt"] = {item = 267, texture = 0}, -- T Shirt
